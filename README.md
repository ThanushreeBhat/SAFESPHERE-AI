...
-Spatial Risk Heatmap: Interactive 2D plant blueprint displaying live zone statuses.

-Compound Hazard Engine: Fuses gas PPM, temperature, and active permit types to catch multi-variable risks.
...
-REST API Layer: /status and /trigger-hazard endpoints for real-time simulation control.

-Resilient WebSockets: Streams telemetry every 2 seconds with automatic 3-second 
reconnection.
